...
#define __FONT_H
// ASCII Table: 6*12
// Shift the ASCII code by -32 to get the index of the character in the table
...
typedef struct
{
    const FontTypeDef16 *Font16;
    uint8_t Font16Size;
    const FontTypeDef24 *Font24;
    uint8_t Font24Size;
    const FontTypeDef32 *Font32;
    uint8_t Font32Size;
} FontSetTypeDef;

const FontTypeDef16 myFonts16[] = {
    {.UTF8Code = "深", .Data = {0x00, 0x00, 0x27, 0xFC, 0x14, 0x04, 0x14, 0xA4, 0x81, 0x10, 0x42, 0x08, 0x40, 0x40, 0x10, 0x40, 
            0x17, 0xFC, 0x20, 0x40, 0xE0, 0xE0, 0x21, 0x50, 0x22, 0x48, 0x2C, 0x46, 0x20, 0x40, 0x00, 0x40}},
    {.UTF8Code = "圳", .Data = {0x11, 0x04, 0x11, 0x24, 0x11, 0x24, 0x11, 0x24, 0x11, 0x24, 0xFD, 0x24, 0x11, 0x24, 0x11, 0x24, 
            0x11, 0x24, 0x11, 0x24, 0x11, 0x24, 0x1D, 0x24, 0xE1, 0x24, 0x42, 0x24, 0x02, 0x04, 0x04, 0x04}}
};

const FontTypeDef24 myFonts24[] = {
    {.UTF8Code = "步",
     .Data = {0x00,0x00,0x00,0x00,0x02,0x00,0x00,0x02,0x00,0x00,0x02,0x00,0x00,0x82,0x00,0x00,
            0x83,0xFE,0x00,0x82,0x00,0x00,0x82,0x00,0x00,0x82,0x00,0x3F,0xFF,0xFF,0x00,0x02,
            0x00,0x00,0x02,0x00,0x00,0xC2,0x02,0x01,0x82,0x02,0x03,0x02,0x04,0x0C,0x02,0x08,
            0x08,0x02,0x10,0x00,0x02,0x20,0x00,0x00,0xC0,0x00,0x03,0x00,0x00,0x1C,0x00,0x1F,
            0xE0,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
    {.UTF8Code = "数",
     .Data = {0x00,0x00,0x00,0x00,0x80,0x30,0x00,0x84,0x20,0x08,0x88,0x60,0x04,0x90,0x40,0x04,
            0x90,0x40,0x3F,0xFC,0xFD,0x01,0x80,0x82,0x02,0xE1,0x02,0x06,0x93,0x06,0x08,0x8F,
            0x84,0x30,0x80,0x84,0x01,0x00,0x84,0x01,0x00,0x4C,0x3F,0xF8,0x48,0x04,0x10,0x28,
            0x04,0x10,0x30,0x0C,0x20,0x38,0x03,0xC0,0x6C,0x00,0xF0,0x86,0x03,0x0B,0x03,0x3C,
            0x0E,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
    {.UTF8Code = "温",
    .Data = {0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x00,0x00,0x06,0x1F,0xFC,0x03,0x10,0x04,0x00,
            0x10,0x04,0x00,0x1F,0xFC,0x00,0x10,0x04,0x60,0x10,0x04,0x18,0x10,0x04,0x0C,0x3F,
            0xFC,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x7F,0xFF,0x06,0x42,0x22,0x04,0x42,0x22,
            0x04,0x42,0x22,0x08,0x42,0x22,0x08,0x42,0x22,0x10,0x42,0x22,0x31,0xFF,0xFF,0x10,
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
    {.UTF8Code = "湿",
    .Data = {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0C,0x7F,0xFE,0x02,0x20,0x02,0x00,
            0x20,0x02,0x00,0x3F,0xFE,0x00,0x20,0x02,0x20,0x20,0x02,0x10,0x20,0x02,0x0C,0x7F,
            0xFE,0x00,0x02,0x20,0x00,0x02,0x20,0x02,0x42,0x22,0x02,0x62,0x24,0x04,0x22,0x24,
            0x04,0x12,0x28,0x08,0x12,0x38,0x08,0x02,0x20,0x18,0x02,0x20,0x11,0xFF,0xFF,0x00,
            0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
    {.UTF8Code = "度",
    .Data = {0x00,0x00,0x00,0x00,0x04,0x00,0x00,0x03,0x00,0x00,0x00,0x80,0x07,0xFF,0xFF,0x04,
            0x00,0x00,0x04,0x10,0x10,0x04,0x10,0x10,0x05,0xFF,0xFF,0x04,0x10,0x10,0x04,0x10,
            0x10,0x04,0x1F,0xF0,0x04,0x00,0x00,0x04,0x00,0x00,0x04,0xFF,0xF8,0x0C,0x18,0x10,
            0x08,0x0C,0x20,0x08,0x06,0x40,0x08,0x03,0x80,0x10,0x06,0xC0,0x30,0x18,0x3C,0x03,
            0xE0,0x03,0x00,0x00,0x00,0x00,0x00,0x00}}

};

const FontTypeDef32 myFonts32[] = {
    {.UTF8Code = "步",
     .Data = {}},
    {.UTF8Code = "数",
     .Data = {}},
    {.UTF8Code = "温",
    .Data = {}},
    {.UTF8Code = "湿",
    .Data = {}},
    {.UTF8Code = "度",
    .Data = {}}

};

const FontSetTypeDef FontType[] = {
    {myFonts16, sizeof(myFonts16) / sizeof(FontTypeDef16), myFonts24, sizeof(myFonts24) / sizeof(FontTypeDef24), myFonts32, sizeof(myFonts32) / sizeof(FontTypeDef32)},
};
#endif
